...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT08), 0x00000020u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT09), 0x00000011u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT12), 0x00000011u);
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B00), 0x80000009u);

	/* CYDEV_CLK_DIVIDER_C00 Starting address: CYDEV_CLK_DIVIDER_C00 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C00), 0x80000022u);

	/* CYDEV_CLK_DIVIDER_A01 Starting address: CYDEV_CLK_DIVIDER_A01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A01), 0x800000EFu);
...
static void AnalogSetDefault(void)
{
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x00000042u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x00000042u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F302Bu, /* Base address: 0x400F3000 Count: 43 */
			0x400F312Au, /* Base address: 0x400F3100 Count: 42 */
			0x400F3255u, /* Base address: 0x400F3200 Count: 85 */
			0x400F333Fu, /* Base address: 0x400F3300 Count: 63 */
			...
			0x400F431Au, /* Base address: 0x400F4300 Count: 26 */
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0x02000060u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL2), 0x20000000u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL3), 0x2222EE00u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x30040000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG12), 0x00001000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA2_CFG8), 0xC0000000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA2_CFG12), 0x0000C000u);

		/* UDB_PA_3 Starting address: CYDEV_UDB_PA3_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA3_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG8), 0x1E000000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG12), 0x0000FF00u);

		/* TCPWM_CNT1 Starting address: CYDEV_TCPWM_CNT1_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT1_TR_CTRL0), 0x0000008Eu);
	...
	CY_SET_REG32((void *)(CYDEV_PRT0_BASE), 0x0000004Fu);
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x00180580u);
	CY_SET_REG32((void *)(CYREG_PRT0_PC2), 0x00000003u);
	...
	CY_SET_REG32((void *)(CYDEV_PRT2_BASE), 0x000000DEu);
	CY_SET_REG32((void *)(CYREG_PRT2_PC), 0x00C02480u);
	CY_SET_REG32((void *)(CYREG_PRT2_PC2), 0x00000042u);

	/* IOPINS0_3 Starting address: CYDEV_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT3_BASE), 0x000000F0u);
	CY_SET_REG32((void *)(CYREG_PRT3_PC), 0x00DB6D80u);
