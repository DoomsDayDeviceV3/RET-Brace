// ======================================================================
// control_v3.v generated from TopDesign.cysch
// 03/27/2025 at 09:28
...
module ADC_SAR_SEQ_P4_v2_50_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("1388b4ef-0925-4634-9cb5-cf94c0cf4760/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("1388b4ef-0925-4634-9cb5-cf94c0cf4760/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("62500000"),
		  .is_direct(0),
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=233, Polarity=0, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=IDAC_Iref, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC_Iref, CY_INSTANCE_SHORT_NAME=IDAC_Iref, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=IDAC_Iref, )
...
// LPComp_P4_v2_20(DBGW_LPCOMP_IP_V0=true, DBGW_LPCOMP_IP_V2=false, DigitalFilter=0, Hysteresis=0, Interrupt=1, InterruptEnabled=false, LegacyOutputPosition=true, OutputMode=0, Speed=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=LPComp_P4_v2_20, CY_CONFIG_TITLE=LPComp_OC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LPComp_OC, CY_INSTANCE_SHORT_NAME=LPComp_OC, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=LPComp_OC, )
...
module top ;
    ...
    if (1)
    begin : LUT_Spd
        reg [1:0] tmp__LUT_Spd_reg;
        wire [2:0] tmp__LUT_Spd_ins;
        assign tmp__LUT_Spd_ins = {H3,H2,H1};
        always @(tmp__LUT_Spd_ins)
        begin
            case (tmp__LUT_Spd_ins)
                3'b000 :  tmp__LUT_Spd_reg = 2'b01;
                3'b001 :  tmp__LUT_Spd_reg = 2'b00;
                3'b010 :  tmp__LUT_Spd_reg = 2'b00;
                3'b011 :  tmp__LUT_Spd_reg = 2'b00;
                3'b100 :  tmp__LUT_Spd_reg = 2'b00;
                3'b101 :  tmp__LUT_Spd_reg = 2'b10;
                3'b110 :  tmp__LUT_Spd_reg = 2'b00;
                3'b111 :  tmp__LUT_Spd_reg = 2'b01;
            endcase
        end
        assign {Net_469,Net_470} = tmp__LUT_Spd_reg;
    end
    // -- LUT LUT_Spd end --


	cy_clock_v1_0
		#(.id("55f54662-2be7-4b4e-820c-4e12077a627f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("5000000000"),
		  .is_direct(0),
    ...
    CyStatusReg_v1_90 Hall_Error (
        ...
        .intr(Net_565),
        .status_bus(8'b0));
    defparam Hall_Error.Bit0Mode = 0;
    defparam Hall_Error.Bit1Mode = 0;
    defparam Hall_Error.Bit2Mode = 0;
    defparam Hall_Error.Bit3Mode = 0;
    defparam Hall_Error.Bit4Mode = 0;
    defparam Hall_Error.Bit5Mode = 0;
    defparam Hall_Error.Bit6Mode = 0;
    defparam Hall_Error.Bit7Mode = 0;
    defparam Hall_Error.BusDisplay = 0;
    defparam Hall_Error.Interrupt = 0;
    defparam Hall_Error.MaskValue = 0;
    defparam Hall_Error.NumInputs = 1;

    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge CLK_200K)
    begin
        cy_tff_1 <= Net_567^Net_916;
    end
    assign Net_916 = cy_tff_1;
    // -- TFF End --

    assign Net_567 = 1'h1;

    TCPWM_P4_v2_10_0 PWM_Drive (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__PWMCL_net;
	wire [0:0] tmpFB_0__PWMCL_net;
	wire [0:0] tmpIO_0__PWMCL_net;
	wire [0:0] tmpINTERRUPT_0__PWMCL_net;
	electrical [0:0] tmpSIOVREF__PWMCL_net;

	cy_psoc3_pins_v1_10
		#(.id("d810f0f1-a79b-4ebd-99c4-67941886b6f2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		PWMCL
		 (.oe(tmpOE__PWMCL_net),
		  .y({Net_211}),
		  .fb({tmpFB_0__PWMCL_net[0:0]}),
		  .io({tmpIO_0__PWMCL_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMCL_net),
		  .interrupt({tmpINTERRUPT_0__PWMCL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMCL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_209} : {Net_209};

	wire [0:0] tmpOE__PWMBL_net;
	wire [0:0] tmpFB_0__PWMBL_net;
	wire [0:0] tmpIO_0__PWMBL_net;
	wire [0:0] tmpINTERRUPT_0__PWMBL_net;
	electrical [0:0] tmpSIOVREF__PWMBL_net;

	cy_psoc3_pins_v1_10
		#(.id("105641ad-099b-4de4-ab19-84d305aa5c9b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		PWMBL
		 (.oe(tmpOE__PWMBL_net),
		  .y({Net_210}),
		  .fb({tmpFB_0__PWMBL_net[0:0]}),
		  .io({tmpIO_0__PWMBL_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMBL_net),
		  .interrupt({tmpINTERRUPT_0__PWMBL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMBL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_209} : {Net_209};

	wire [0:0] tmpOE__PWMAL_net;
	wire [0:0] tmpFB_0__PWMAL_net;
	wire [0:0] tmpIO_0__PWMAL_net;
	wire [0:0] tmpINTERRUPT_0__PWMAL_net;
	electrical [0:0] tmpSIOVREF__PWMAL_net;

	cy_psoc3_pins_v1_10
		#(.id("40d5aa5e-3cdb-4762-b3c1-b4f53c74bcdc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		PWMAL
		 (.oe(tmpOE__PWMAL_net),
		  .y({Net_1124}),
		  .fb({tmpFB_0__PWMAL_net[0:0]}),
		  .io({tmpIO_0__PWMAL_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMAL_net),
		  .interrupt({tmpINTERRUPT_0__PWMAL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMAL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_209} : {Net_209};

	wire [0:0] tmpOE__PWMCH_net;
	wire [0:0] tmpFB_0__PWMCH_net;
	wire [0:0] tmpIO_0__PWMCH_net;
	wire [0:0] tmpINTERRUPT_0__PWMCH_net;
	electrical [0:0] tmpSIOVREF__PWMCH_net;

	cy_psoc3_pins_v1_10
		#(.id("1603659b-8f77-432d-8a8d-c2f1f365763f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		PWMCH
		 (.oe(tmpOE__PWMCH_net),
		  .y({Net_101}),
		  .fb({tmpFB_0__PWMCH_net[0:0]}),
		  .io({tmpIO_0__PWMCH_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMCH_net),
		  .interrupt({tmpINTERRUPT_0__PWMCH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMCH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_209} : {Net_209};

	wire [0:0] tmpOE__PWMBH_net;
	wire [0:0] tmpFB_0__PWMBH_net;
	wire [0:0] tmpIO_0__PWMBH_net;
	wire [0:0] tmpINTERRUPT_0__PWMBH_net;
	electrical [0:0] tmpSIOVREF__PWMBH_net;

	cy_psoc3_pins_v1_10
		#(.id("587599c0-9e06-4ac8-99e2-24c9e9184e72"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		PWMBH
		 (.oe(tmpOE__PWMBH_net),
		  .y({Net_282}),
		  .fb({tmpFB_0__PWMBH_net[0:0]}),
		  .io({tmpIO_0__PWMBH_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMBH_net),
		  .interrupt({tmpINTERRUPT_0__PWMBH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMBH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_209} : {Net_209};

	wire [0:0] tmpOE__PWMAH_net;
	wire [0:0] tmpFB_0__PWMAH_net;
	wire [0:0] tmpIO_0__PWMAH_net;
	wire [0:0] tmpINTERRUPT_0__PWMAH_net;
	electrical [0:0] tmpSIOVREF__PWMAH_net;

	cy_psoc3_pins_v1_10
		#(.id("7a9b4df4-2f83-4be5-8a09-b6a5b383458a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		PWMAH
		 (.oe(tmpOE__PWMAH_net),
		  .y({Net_96}),
		  .fb({tmpFB_0__PWMAH_net[0:0]}),
		  .io({tmpIO_0__PWMAH_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMAH_net),
		  .interrupt({tmpINTERRUPT_0__PWMAH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMAH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_209} : {Net_209};
	...
	cy_psoc3_pins_v1_10
		#(.id("8ce91acc-92f8-4a67-985f-3ec9e546532a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Hall3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("456c94f0-cc7d-4386-9c79-0dcb4af9b5bf"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8848056a-0efc-4fba-9cb6-d04acc84e142"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Hall1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyControlReg_v1_80 CtrlReg_Dir (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam CtrlReg_Dir.Bit0Mode = 0;
    defparam CtrlReg_Dir.Bit1Mode = 0;
    ...
    defparam CtrlReg_Dir.ExtrReset = 0;
    defparam CtrlReg_Dir.NumOutputs = 1;


    assign Net_281 = H3 ^ Net_272;


    assign Net_634 = H2 ^ Net_272;

    CyControlReg_v1_80 CtrlReg_PWMOut (
        .control_1(Net_209),
        .control_2(Net_598),
        .control_3(Net_599),
        .control_0(Net_190),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam CtrlReg_PWMOut.Bit0Mode = 0;
    defparam CtrlReg_PWMOut.Bit1Mode = 0;
    defparam CtrlReg_PWMOut.Bit2Mode = 0;
    defparam CtrlReg_PWMOut.Bit3Mode = 0;
    defparam CtrlReg_PWMOut.Bit4Mode = 0;
    defparam CtrlReg_PWMOut.Bit5Mode = 0;
    defparam CtrlReg_PWMOut.Bit6Mode = 0;
    defparam CtrlReg_PWMOut.Bit7Mode = 0;
    defparam CtrlReg_PWMOut.BitValue = 0;
    defparam CtrlReg_PWMOut.BusDisplay = 0;
    defparam CtrlReg_PWMOut.ExtrReset = 0;
    defparam CtrlReg_PWMOut.NumOutputs = 2;


	cy_clock_v1_0
		#(.id("cb47d653-b2be-4e94-a718-cda5765a53f5"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    assign Net_99 = Net_157 & Net_190;

    // -- LUT LUT_Cmut start --
    if (1)
    begin : LUT_Cmut
        reg [5:0] tmp__LUT_Cmut_reg;
        wire [3:0] tmp__LUT_Cmut_ins;
        assign tmp__LUT_Cmut_ins = {Net_99,Net_281,Net_634,Net_278};
        always @(tmp__LUT_Cmut_ins)
        begin
            case (tmp__LUT_Cmut_ins)
                4'b0000 :  tmp__LUT_Cmut_reg = 6'b000000;
                4'b0001 :  tmp__LUT_Cmut_reg = 6'b100000;
                4'b0010 :  tmp__LUT_Cmut_reg = 6'b010000;
                4'b0011 :  tmp__LUT_Cmut_reg = 6'b100000;
                4'b0100 :  tmp__LUT_Cmut_reg = 6'b001000;
                4'b0101 :  tmp__LUT_Cmut_reg = 6'b001000;
                4'b0110 :  tmp__LUT_Cmut_reg = 6'b010000;
                4'b0111 :  tmp__LUT_Cmut_reg = 6'b000000;
                4'b1000 :  tmp__LUT_Cmut_reg = 6'b000000;
                4'b1001 :  tmp__LUT_Cmut_reg = 6'b100010;
                4'b1010 :  tmp__LUT_Cmut_reg = 6'b010001;
                4'b1011 :  tmp__LUT_Cmut_reg = 6'b100001;
                4'b1100 :  tmp__LUT_Cmut_reg = 6'b001100;
                4'b1101 :  tmp__LUT_Cmut_reg = 6'b001010;
                4'b1110 :  tmp__LUT_Cmut_reg = 6'b010100;
                4'b1111 :  tmp__LUT_Cmut_reg = 6'b000000;
            endcase
        end
        assign {Net_211,Net_210,Net_1124,Net_101,Net_282,Net_96} = tmp__LUT_Cmut_reg;
    end
    // -- LUT LUT_Cmut end --
	...
	cy_psoc3_pins_v1_10
		#(.id("df3ad7ed-e742-4705-938c-80177e321b8e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    ADC_SAR_SEQ_P4_v2_50_2 ADC_SAR_Seq_1 (
        .Vref(Net_629),
        .sdone(Net_630),
        .eoc(Net_631),
        .aclk(1'b0),
    ...
    IDAC_P4_v1_10_3 IDAC_Iref (
        .Iout(Net_398));

	wire [0:0] tmpOE__Pin_Ibus_net;
	wire [0:0] tmpFB_0__Pin_Ibus_net;
	wire [0:0] tmpIO_0__Pin_Ibus_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Ibus_net;
	electrical [0:0] tmpSIOVREF__Pin_Ibus_net;

	cy_psoc3_pins_v1_10
		#(.id("6cd5cccf-835b-43ca-bda3-62d3dda301de"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Ibus
		 (.oe(tmpOE__Pin_Ibus_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Ibus_net[0:0]}),
		  .analog({Net_391}),
		  .io({tmpIO_0__Pin_Ibus_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Ibus_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Ibus_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Ibus_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_Iref_net;
	wire [0:0] tmpFB_0__Pin_Iref_net;
	wire [0:0] tmpIO_0__Pin_Iref_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Iref_net;
	electrical [0:0] tmpSIOVREF__Pin_Iref_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Iref
		 (.oe(tmpOE__Pin_Iref_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Iref_net[0:0]}),
		  .analog({Net_398}),
		  .io({tmpIO_0__Pin_Iref_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Iref_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Iref_net[0:0]}),
		  .annotation({Net_385}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Iref_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    LPComp_P4_v2_20_4 LPComp_OC (
        .Vplus(Net_391),
        .Vminus(Net_398),
        .intr(Net_412),
        .CmpOut(Net_633));
	...
	wire [0:0] tmpOE__Vrpm_net;
	wire [0:0] tmpFB_0__Vrpm_net;
	wire [0:0] tmpIO_0__Vrpm_net;
	wire [0:0] tmpINTERRUPT_0__Vrpm_net;
	electrical [0:0] tmpSIOVREF__Vrpm_net;

	cy_psoc3_pins_v1_10
		#(.id("a8f514a9-4dff-478d-adf6-1ecab0dc8294"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Vrpm
		 (.oe(tmpOE__Vrpm_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vrpm_net[0:0]}),
		  .analog({Net_215}),
		  .io({tmpIO_0__Vrpm_net[0:0]}),
		  .siovref(tmpSIOVREF__Vrpm_net),
		  .interrupt({tmpINTERRUPT_0__Vrpm_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vrpm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_5 Counter_Spd (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(Net_916),
