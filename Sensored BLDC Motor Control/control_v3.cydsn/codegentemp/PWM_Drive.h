...
#define PWM_Drive_QUAD_AUTO_START                (0lu)
...
/* Signal present */
#define PWM_Drive_QUAD_INDEX_SIGNAL_PRESENT      (0lu)
#define PWM_Drive_QUAD_STOP_SIGNAL_PRESENT       (0lu)
...
/* Signal present */
#define PWM_Drive_TC_RELOAD_SIGNAL_PRESENT       (0lu)
#define PWM_Drive_TC_COUNT_SIGNAL_PRESENT        (0lu)
#define PWM_Drive_TC_START_SIGNAL_PRESENT        (0lu)
#define PWM_Drive_TC_STOP_SIGNAL_PRESENT         (0lu)
#define PWM_Drive_TC_CAPTURE_SIGNAL_PRESENT      (0lu)
...
#define PWM_Drive_PWM_ALIGN                      (1lu)
#define PWM_Drive_PWM_RUN_MODE                   (0lu)
#define PWM_Drive_PWM_DEAD_TIME_CYCLE            (0lu)
...
/* Interrupt Mask */
#define PWM_Drive_PWM_INTERRUPT_MASK             (1lu)
...
/* PWM Mode */
#define PWM_Drive_PWM_PERIOD_VALUE               (239lu)
#define PWM_Drive_PWM_PERIOD_BUF_VALUE           (65535lu)
#define PWM_Drive_PWM_PERIOD_SWAP                (0lu)
#define PWM_Drive_PWM_COMPARE_VALUE              (0lu)
#define PWM_Drive_PWM_COMPARE_BUF_VALUE          (65535lu)
