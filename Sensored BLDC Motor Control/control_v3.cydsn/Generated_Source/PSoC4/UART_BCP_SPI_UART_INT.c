...
#ifdef UART_BCP_SPI_UART_ISR_ENTRY_CALLBACK
    UART_BCP_SPI_UART_ISR_EntryCallback();
#endif /* UART_BCP_SPI_UART_ISR_ENTRY_CALLBACK */
...
#ifdef UART_BCP_SPI_UART_ISR_EXIT_CALLBACK
    UART_BCP_SPI_UART_ISR_ExitCallback();
#endif /* UART_BCP_SPI_UART_ISR_EXIT_CALLBACK */
