...
void Counter_Spd_Enable(void)
{
    ...
    #if (Counter_Spd__QUAD == Counter_Spd_CONFIG)
        #if (0u != Counter_Spd_QUAD_AUTO_START)
            Counter_Spd_TriggerCommand(Counter_Spd_MASK, Counter_Spd_CMD_RELOAD);
        #endif /* (0u != Counter_Spd_QUAD_AUTO_START) */
    #endif  /* (Counter_Spd__QUAD == Counter_Spd_CONFIG) */
}
...
*   Values:
*     - Counter_Spd_CMD_CAPTURE    - Trigger Capture/Switch command
*     - Counter_Spd_CMD_RELOAD     - Trigger Reload/Index command
*     - Counter_Spd_CMD_STOP       - Trigger Stop/Kill command
*     - Counter_Spd_CMD_START      - Trigger Start/phiB command
*
* Return:
*  None
*
